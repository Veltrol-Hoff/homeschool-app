...
file_path = 'src/app/settings/students/StudentSettingsForm.tsx'
...
old_add_form = """<form onSubmit={handleAddYear} className="flex flex-wrap gap-2 mb-6 bg-stone-100  p-4 rounded-lg border border-stone-200">
...
new_add_form = """<form onSubmit={handleAddYear} className="flex flex-wrap gap-2 mb-6 bg-stone-100 p-4 rounded-lg border border-stone-200">
...
with open(file_path, 'w', encoding='utf-8') as f:
    f.write(content)
print("Updated StudentSettingsForm.tsx")
